...
import ru.piggybox.core.bot.common.command.mapping.CallbackQueryMapping;
...
public class DefaultCallbackCommandDelegatorFactory implements CallbackCommandDelegatorFactory {
    ...
    @PostConstruct
    void init() {
        Map<String, CallbackCommand> commandsMap = callbackCommandControllers.stream().map(controller -> {
